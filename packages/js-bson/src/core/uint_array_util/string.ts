export function cu_readByUtf8(buf: Uint8Array) {
    let str = "";
...
export function cu_writeByUtf8(str: string): Uint8Array {
...
const isNode = typeof (globalThis as any).Buffer === "function";

export const readByUtf8 = isNode
    ? function readByUtf8(buf: Uint8Array): string {
          return Buffer.prototype.utf8Slice.call(buf);
      }
    : cu_readByUtf8;
export const writeByUtf8 = isNode
    ? function readByUtf8(str: string): Uint8Array {
